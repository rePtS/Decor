                              ...
                              const std::wstring &logPrefix)
{
    ...
    // Light sources
    // Ќужна коллекци€ дл€ всех статических источников света (и точечных, и прожекторов и солнечный свет)
    // –езервируем место дл€ источников, заполн€ем их основные характеристики (цвет, интенсивность, радиус, направление и т.п.)
    // ѕри проходе по иерархии узлов заполн€ем положение источника света в пространстве
    mLights.clear();
