...
export module MikkTSpace;

export typedef int tbool;
export typedef struct SMikkTSpaceContext SMikkTSpaceContext;
...
export struct SMikkTSpaceContext
{
...
export tbool genTangSpaceDefault(const SMikkTSpaceContext* pContext);	// Default (recommended) fAngularThreshold is 180 degrees (which means threshold disabled)
export tbool genTangSpace(const SMikkTSpaceContext* pContext, const float fAngularThreshold);
